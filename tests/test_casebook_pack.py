"""Regression checks for the axiom-store-index-runner casebook."""
...
from casebook.harness import assert_expected, axiom_store_index_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(axiom_store_index_runner_summary(), assert_expected())
