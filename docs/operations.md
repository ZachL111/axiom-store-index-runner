...
`axiom-store-index-runner` is centered on databases work in Swift. The technical target is: Develop a Swift command-oriented project for index scenarios with log and snapshot fixtures, replay consistency checks, and synthetic fixtures only.
